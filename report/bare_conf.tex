...
\begin{figure}[htb]
\centering
\includegraphics[width=1\textwidth]{plot_de3a}
\caption{Missing Values Percentages on the test set.}
\label{fig_de3a}
\end{figure}
%
\begin{figure}[htb]
\centering
\includegraphics[width=1\textwidth]{plot_de3b}
\caption{Missing Values Percentages on the test set.}
\label{fig_de3b}
\end{figure}
